...
public class SimpleDomainGenerator extends AbstractJavaGenerator {

    public SimpleDomainGenerator(String project) {
        super(project);
    }
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        FullyQualifiedJavaType type = new FullyQualifiedJavaType(introspectedTable.getBaseDomainType());
